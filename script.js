...
async function getFolders () {
    let songs = await fetch("https://nitinbhaskar7.github.io//items/songs/");
    ...
    folders.forEach(async (path) => {
        let folder = await fetch("https://nitinbhaskar7.github.io///"+ path + "desc.json");
        let descr = await folder.json() ;
        let cover = "https://nitinbhaskar7.github.io///" + path + "cover.jpg"
        // console.log(descr)
...
async function getSongs() {
    ...
    let f = await fetch(`https://nitinbhaskar7.github.io//items/songs/${currFolder}`);
...
const playSong =  (currSongName) => {
    ...
    document.body.querySelectorAll(".currsongName")[0].innerHTML = ` <img src="${"https://nitinbhaskar7.github.io//items/songs/" + currFolder + "/cover.jpg"}" class="rounded"
                            width="40" alt=""> <div> <div>${currSongName}</div> <div class="currartist">${artist}</div> </div>   `
    document.body.querySelectorAll(".currsongName")[1].innerHTML = ` <img src="${"https://nitinbhaskar7.github.io//items/songs/" + currFolder + "/cover.jpg"}" class="rounded"
